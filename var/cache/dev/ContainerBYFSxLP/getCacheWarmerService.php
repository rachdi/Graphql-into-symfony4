...
return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
    yield 0 => ($this->privates['Overblog\GraphQLBundle\CacheWarmer\CompileCacheWarmer'] ?? $this->load(__DIR__.'/getCompileCacheWarmerService.php'));
    ...
    yield 7 => ($this->privates['doctrine.orm.proxy_cache_warmer'] ?? $this->load(__DIR__.'/getDoctrine_Orm_ProxyCacheWarmerService.php'));
}, 8));
